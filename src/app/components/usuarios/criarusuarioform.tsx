  ...
  return(
    <form action={criarUsuario}>
      <label htmlFor="nome">Nome completo
        <input className="" type="text" name="nome" id="nome" required />
      </label>
      <label htmlFor="setor">Setor
        <input className="" type="text" name="setor" id="setor" required />
      </label>
      <label htmlFor="cargo">Cargo
        <input className="" type="text" name="cargo" id="cargo" required />
      </label>
      <label htmlFor="usuario">Nome de usuário
        <input className="" type="text" name="usuario" id="usuario" required />
      </label>
      <label htmlFor="senha">Senha
        <input className="" type="password" name="senha" id="senha" required />
      </label>
      <BotaoCriarUsuario />
    </form>
  );
